...
from fetcher import update_pull_request_pages 
from cleaner import clean_pr_data 
from metrics import calculate_pr_metrics, update_metrics 
...
def update_data(repo_details):
    ...
    pr_data_file = update_pull_request_pages(config, repo_details)
    ...
    updated_metrics_df = update_metrics(engine, table_name, pr_metrics_df)
    
    load_to_db(updated_metrics_df, engine, table_name)
